...
<html lang="en">
    ...
    <body class="top-navbar-fixed" style="background-color: e8a2ff;">
        <div class="main-wrapper">
            ...
            <div class="content-wrapper">
                <div class="content-container">
                    ...
                    <div class="main-page" style="background-color: #e8a2ff; ">
                        <div class="container-fluid">
                            <div class="row page-title-div" style="background-color: #bf00ff; ">
                                <div class="col-sm-6" >
